...
exports.mealPrompt = void 0;
const mealPrompt = (request) => {
    ...
    if (request.isDairyFree)
        dietaryRestrictions.push('dairy-free');
    if (request.isKeto)
        dietaryRestrictions.push('keto');
    if (request.isLowCarb)
        dietaryRestrictions.push('low-carb');
    if (request.isHighProtein)
...
exports.mealPrompt = mealPrompt;
exports.default = exports.mealPrompt;
